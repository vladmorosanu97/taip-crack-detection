...
# used for when the data set is limited to generate new data by rotations and translations + to avoid overfitting
...
# created label (masks for simple images, without labels)
def tolabel():
